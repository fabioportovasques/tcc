...
ALTER TABLE funcionario-fichaepi ADD FOREIGN KEY(matricula_funcionario) REFERENCES funcionario (matricula_funcionario)
ALTER TABLE executa ADD FOREIGN KEY(cod_tarefa) REFERENCES tarefa (cod_tarefa)
ALTER TABLE executa ADD FOREIGN KEY(matricula_funcionario) REFERENCES funcionario (matricula_funcionario)
ALTER TABLE funcionario ADD FOREIGN KEY(cod_cargo) REFERENCES cargo (cod_cargo)

--faltou exportar todas as relações
