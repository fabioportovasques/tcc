...
--
-- Table structure for table `epi_ficha_epi`
--

DROP TABLE IF EXISTS `epi_ficha_epi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `epi_ficha_epi` (
  `epi_cod_epi` int(11) NOT NULL,
  `ficha_epi_cod_ficha_epi` int(11) NOT NULL,
  PRIMARY KEY (`epi_cod_epi`,`ficha_epi_cod_ficha_epi`),
  KEY `fk_epi_has_ficha_epi_ficha_epi1_idx` (`ficha_epi_cod_ficha_epi`),
  KEY `fk_epi_has_ficha_epi_epi1_idx` (`epi_cod_epi`),
  CONSTRAINT `fk_epi_has_ficha_epi_epi1` FOREIGN KEY (`epi_cod_epi`) REFERENCES `epi` (`cod_epi`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_epi_has_ficha_epi_ficha_epi1` FOREIGN KEY (`ficha_epi_cod_ficha_epi`) REFERENCES `ficha_epi` (`cod_ficha_epi`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `epi_ficha_epi`
--

LOCK TABLES `epi_ficha_epi` WRITE;
/*!40000 ALTER TABLE `epi_ficha_epi` DISABLE KEYS */;
INSERT INTO `epi_ficha_epi` VALUES (1,1);
/*!40000 ALTER TABLE `epi_ficha_epi` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `ficha_epi` (
  ...
  `data_devolucao_ficha` date DEFAULT NULL,
  `obs_devolucao_ficha` varchar(120) NOT NULL,
  `quantidade_epi_ficha` int(11) NOT NULL,
  `cod_motivo_baixa` int(11) DEFAULT NULL,
  `cod_motivo_obtencao` int(11) NOT NULL,
  PRIMARY KEY (`cod_ficha_epi`),
  KEY `fk_ficha_epi_motivo1_idx` (`cod_motivo_baixa`),
  KEY `fk_ficha_epi_motivo_obtencao1_idx` (`cod_motivo_obtencao`),
  CONSTRAINT `fk_ficha_epi_motivo1` FOREIGN KEY (`cod_motivo_baixa`) REFERENCES `motivo_baixa` (`cod_motivo_baixa`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_ficha_epi_motivo_obtencao1` FOREIGN KEY (`cod_motivo_obtencao`) REFERENCES `motivo_obtencao` (`cod_motivo_obtencao`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
INSERT INTO `ficha_epi` VALUES (1,'2020-08-15',NULL,'epi calçados',1,NULL,1);
...
--
-- Table structure for table `funcionario_ficha_epi`
--

DROP TABLE IF EXISTS `funcionario_ficha_epi`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `funcionario_ficha_epi` (
  `funcionario_matricula_func` int(11) NOT NULL,
  `ficha_epi_cod_ficha_epi` int(11) NOT NULL,
  PRIMARY KEY (`funcionario_matricula_func`,`ficha_epi_cod_ficha_epi`),
  KEY `fk_funcionario_has_ficha_epi_ficha_epi1_idx` (`ficha_epi_cod_ficha_epi`),
  KEY `fk_funcionario_has_ficha_epi_funcionario1_idx` (`funcionario_matricula_func`),
  CONSTRAINT `fk_funcionario_has_ficha_epi_ficha_epi1` FOREIGN KEY (`ficha_epi_cod_ficha_epi`) REFERENCES `ficha_epi` (`cod_ficha_epi`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_funcionario_has_ficha_epi_funcionario1` FOREIGN KEY (`funcionario_matricula_func`) REFERENCES `funcionario` (`matricula_func`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `funcionario_ficha_epi`
--

LOCK TABLES `funcionario_ficha_epi` WRITE;
/*!40000 ALTER TABLE `funcionario_ficha_epi` DISABLE KEYS */;
INSERT INTO `funcionario_ficha_epi` VALUES (1,1);
/*!40000 ALTER TABLE `funcionario_ficha_epi` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `motivo_baixa` (
  `cod_motivo_baixa` int(11) NOT NULL AUTO_INCREMENT,
  `nome_motivo_baixa` varchar(45) NOT NULL,
  PRIMARY KEY (`cod_motivo_baixa`)
...
INSERT INTO `motivo_baixa` VALUES (1,'termino  de tarefas'),(2,'extravio'),(3,'roubo'),(4,'perda');
/*!40000 ALTER TABLE `motivo_baixa` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `motivo_obtencao`
--

DROP TABLE IF EXISTS `motivo_obtencao`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `motivo_obtencao` (
  `cod_motivo_obtencao` int(11) NOT NULL AUTO_INCREMENT,
  `nome_motivo_obtencao` varchar(45) NOT NULL,
  PRIMARY KEY (`cod_motivo_obtencao`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `motivo_obtencao`
--

LOCK TABLES `motivo_obtencao` WRITE;
/*!40000 ALTER TABLE `motivo_obtencao` DISABLE KEYS */;
INSERT INTO `motivo_obtencao` VALUES (1,'admissao'),(2,'execução de tarefas');
/*!40000 ALTER TABLE `motivo_obtencao` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-09-08 19:32:41
