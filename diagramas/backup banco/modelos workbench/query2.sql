...
CREATE TABLE IF NOT EXISTS `segwareepi`.`funcionario` (
  ...
  INDEX `fk_funcionario_tarefa1_idx` (`tarefa_cod_tarefa` ASC),
  INDEX `fk_funcionario_epi1_idx` (`epi_cod_epi` ASC),
