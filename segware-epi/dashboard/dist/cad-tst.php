                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="userDropdown">
                       ...
                       &nbsp Trocar Usuário</a>
                        ...
                        <a class="dropdown-item"   href="http://localhost/tcc/segware-epi/sobre.php">
                                                                            ...
                                                                            <form action=""  method="POST" name="cad-func" > 
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="   col">
                                                                                        ...
                                                                                        <input type="text" name="matricula-tst" id="matricula-tst" class="form-control " placeholder="matricula "  autocomplete="off" data-toggle="tooltip" data-placement="bottom" title="Insira a matricula do Funcionário cadastrado" required="" >    
                                                                                    </div>
                                                                                </div>
