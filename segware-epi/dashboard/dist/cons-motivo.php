...
<html lang="en">
   ...
   <!--Início container--> <div class="container marcador-container1">
                                        ...
                                        <br />
                                           ...
                                           <h2 class="text-center">Consultar Motivos</h2><br />
                <!--Início da linha-->     <div class="row" >
                                ...
                                <!--Início da coluna-->          <div class="marcador1 col-md-4">
                                                                            ...
                                                                            <form action=""  method="POST" name="cad-func" > 
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="   col">
                                                                                        ...
                                                                                        <input type="text" name="cons-motivo" id="cons-motivo" class="form-control " disabled="" required="" >    
                                                                                    </div>
                                                                                </div>
                                 ...
                                 <!--Início da coluna-->         <div class="marcador1 col-md-6">
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="   col">
                                                                                            <label > Pesquisar Motivo</label>
                                                                                                <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-search" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                                                                    <path fill-rule="evenodd" d="M10.442 10.442a1 1 0 0 1 1.415 0l3.85 3.85a1 1 0 0 1-1.414 1.415l-3.85-3.85a1 1 0 0 1 0-1.415z"/>
                                                                                                    <path fill-rule="evenodd" d="M6.5 12a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11zM13 6.5a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0z"/>
                                                                                                </svg>
                                                                                                <input type="text" name="nome-dep" id="nome-dep" class="form-control" placeholder="Nome do Motivo"  data-toggle="tooltip" data-placement="top" title="Insira o nome do Motivo" autocomplete="off" required="" >
                                                                                    </div>
                                                                                </div>
                ...
                <!--Início da linha-->      <div class="row">
                                ...
                                <!--Início da coluna-->     <div class="bot1 col-md-3">
                                                                        <button class="btn btn-success btn-block" type="submit">Alterar Motivo</button>
                                 <!--Fim da coluna-->       </div>

                                 
                                <!--Início da coluna-->     <div class="bot1 col-md-3">
                                                                        <button class="btn btn-success btn-block" type="submit">Excluir Motivo</button>
                                 <!--Fim da coluna-->       </div>
