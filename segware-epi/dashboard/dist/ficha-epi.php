...
<html lang="en">
   ...
   <!--Início container--> <div class="container marcador-container1">
                                           ...
                                           <h2 class="text-center">Ficha de E.P.I</h2><br />
                                                                            ...
                                                                            <form action=""  method="POST" name="cad-func" > 
                                                                                ...
                                                                                <div class="form-group">
                                                                                     <div class="col">
                                                                                        ...
                                                                                        <input type="text" name="matricula-func" id="matricula-func" class="form-control"  required="" data-toggle="tooltip" data-placement="top" title="Insira a matricula para pesquisar">
                                                                                     </div>   
                                                                                </div>
...
<!--Início da coluna-->          <div class="marcador1 col-md-4">
              ...
              <!--Inpicio da linha-->  <div class="row">
                     <!--Início da coluna-->    <div class="marcador1 col-md-4">
            ...
            <!--fechamento da linha--> </div>
                ...
                <!--Início da linha-->      <div class="row">
                                ...
                                <br />
                                 ...
                                 <?php 
                                        require('tabela-grid-fichaepi.php');
