...
<html lang="en">
    <head>
        ...
        <title>Consulta de E.P.IS</title>
   ...
   <!--Início container--> <div class="container marcador-container1">
                                ...
                                <!--Início da coluna-->          <div class="marcador1 col-md-3">
                                                                            ...
                                                                            <form action=""  method="POST" name="cad-func" > 
                                                                                ...
                                                                                <div class="form-group">
                                                                                    <div class="   col">
                                                                                        <label >Cod de Barras EPI</label>
                                                                                         <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-search" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                                                            <path fill-rule="evenodd" d="M10.442 10.442a1 1 0 0 1 1.415 0l3.85 3.85a1 1 0 0 1-1.414 1.415l-3.85-3.85a1 1 0 0 1 0-1.415z"/>
                                                                                            <path fill-rule="evenodd" d="M6.5 12a5.5 5.5 0 1 0 0-11 5.5 5.5 0 0 0 0 11zM13 6.5a6.5 6.5 0 1 1-13 0 6.5 6.5 0 0 1 13 0z"/>
                                                                                        </svg>
                                                                                        <input type="text" name="cod-epi" id="cod-epi" class="form-control" placeholder="ex: 123456789012" target="_blank" data-toggle="tooltip"  title="Aproxime o Leitor ou Insira manualmente o cod de Barras">    
                                                                                    </div>
                                                                                </div>
                ...
                <!--Fechamento da linha-->  </div>
                 ...
                 <!--Início da linha-->      <div class="row">
                                          ...
                                          <!--Início da coluna-->     <div class="marcador1 col-md-6">
                                                                             ...
                                                                             <div class="form-group">
                                                                                    <div class="   col">
                                                                                        <label for="cidade">Pertence a alguém</label>
                                                                                         <input  type="text" class="form-control"  id="nome-func" id="nome-func"  disabled="" required="">      
                ...
                <!--Início da linha-->      <div class="row">
                                ...
                                <!--Início da coluna-->     <div class="bot1 col-md-2">
                                                                        <button class="btn btn-success btn-block" type="submit">Alterar E.P.I</button>
                                 <!--Fim da coluna-->       </div>
