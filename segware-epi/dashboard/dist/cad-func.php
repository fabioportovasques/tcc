    ...
    <body class="sb-nav-fixed">
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="cad-func.php">Funcionarios</a>
                                    <a class="nav-link" href="cad-dep.php"> Departamentos</a>
                                    <a class="nav-link" href="cad-encarregado.php"> Encarregados</a>
                                    <a class="nav-link" href="cad-fabricante.php"> Fabricante</a>
                                    <a class="nav-link" href="cad-fornecedor.php">Fornecedores</a>
                                    <a class="nav-link" href="cad-motivo-devolucao.php">Motivo Devoluções</a>
                                    <a class="nav-link" href="cad-tst.php">TST</a>
                                    <a class="nav-link" href="cad-epi.php">E.P.IS</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="cad-fabricante.php"> Consultar Tarefa Pendente</a>
                                    <a class="nav-link" href="cad-fornecedor.php">Fornecedores</a>
      ...
      <div class="row">
        ...
        <div class="marcador2 col-md-4 col-xl-10">
                 <div class="card">
                      <div class="card-body">
                            <h4 class="text-md-center"> Cadastro de Funcionários</p></h4>
